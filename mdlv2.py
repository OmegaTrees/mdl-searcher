"""
MyDramaList Search Bot - FIXED VERSION WITH PROPER CLEANUP
Complete standalone version with Firefox process cleanup
"""
...
# ============================================================================
# MyDramaList Scraper (same as before)
# ============================================================================
...
class MyDramaListScraper:
    ...
    PROFILE_PATH = "/root/.0/2/bot_firefox_profile/"
    ...
    async def _ensure_browser(self):
        ...
        if self.context is None:
            ...
            if os.path.exists(self.PROFILE_PATH):
                print(f"📂 Using Firefox profile: {self.PROFILE_PATH}")
                ...
                print(f"⚠️ Profile not found, using default Firefox")
    ...
    async def close(self):
        ...
        try:
            ...
            if self.context:
                ...
                self.context = None  # Reset so it can be reopened
                print("✅ Browser context closed")
            if self.playwright:
                await self.playwright.stop()
                self.playwright = None  # Reset so it can be restarted
